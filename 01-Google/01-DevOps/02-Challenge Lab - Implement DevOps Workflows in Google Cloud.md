...
To run this lab as bash script please use this snippet
```
export ZONE=

curl -sLO https://raw.githubusercontent.com/abdulrahmansamy/cloud/master/01-Google/01-DevOps/bash_scripts/ChallengeLab_ImplementDevOpsWorkflowsinGoogleCloud_GSP330.sh
...
do 
  echo -e "\t Waiting for $PRODNS-deployment-service Load Balancer IP"
  sleep 1
done
